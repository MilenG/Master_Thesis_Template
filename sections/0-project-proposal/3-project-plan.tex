...
You can either use a timeline, as shown below, or a Gantt chart, shown on the right.

% Timeline
% Great and straightforward, but lacks documentation. 
...
\begin{ganttchart}[
    ...
    hgrid
        ...
        % More groups, further tasks omitted
